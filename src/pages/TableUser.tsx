...
import { DataTable } from '@/components/local/users/data-table'
import { columns } from '@/components/local/users/column'
...
export default function TableUser() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const newdata = data.filter((item: any) => item.isShopOwner === false)
      setData(newdata)
    } catch (error) {
